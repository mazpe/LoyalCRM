...
@endif
            ...
            <small>
@if ($value->name == "Active") {
        <span title="{{ $stage_active_desc }}">
@elseif ($value->name == "Pending Activation")
        <span title="{{ $stage_pending_act_desc }}">
@elseif ($value->name == "Sold / CIT")
        <span title="{{ $stage_sold_desc }}">
@elseif ($value->stage == "Very Hot")
        <span title="{{ $stage_very_hot_desc }}">
@elseif ($value->stage == "Hot")
        <span title="{{ $stage_hot_desc }}">
@elseif ($value->stage == "Medium")
        <span title="{{ $stage_medium_desc }}">
@elseif ($value->stage == "Cold")
        <span title="{{ $stage_cold_desc }}">
@elseif ($value->stage == "Dead")
        <span title="{{ $stage_dead_desc }}">
@else
        <span title="">
@endif
