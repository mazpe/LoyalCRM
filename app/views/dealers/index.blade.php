...
<nav class="navbar navbar-inverse">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="{{ URL::to('dealers') }}">View All Dealers</a></li>
        <li><a href="{{ URL::to('dealers/create') }}">Create a Dealer</a>
    </ul>
</nav>
...
@elseif ($value->stage == "Pending Activation")
        <tr style="color: #008000">
@elseif ($value->stage == "Sold / CIT")
        <tr style="color: #FF0000;">
...
@endif
            ...
            <td>
            <span title="{{ $value->stage_description }}">
            <small>
            @if ($value->stage)
                {{ $value->stage }}
            @endif
