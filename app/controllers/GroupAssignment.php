...
class GroupAssignmentController extends \BaseController {

	/**
	 * Display a listing of groupassignment
	 *
	 * @return Response
	 */
	public function index()
	{
		//$groupassignment = Direction::all();
		...
		return View::make('groupassignment.index')
	...
	public function create()
	{
        ...
        return View::make('groupassignment.create')
	...
	public function store()
	{
        ...
        // process the login
        if ($validator->fails()) {
            return Redirect::to('groupassignment/create')
            ...
            return Redirect::to('groupassignment');
        }
	...
	public function show($id)
	{
		...
		return View::make('groupassignment.show', compact('direction'));
	}
	...
	public function edit($id)
	{
        ...
        return View::make('groupassignment.edit')
	...
	public function update($id)
	{
       // validate
        ...
        // process the login
        if ($validator->fails()) {
            return Redirect::to('groupassignment/' . $id . '/edit')
                ->withErrors($validator)
                ->withInput(Input::except('password'));
        } else {
            // store
	...
	public function destroy($id)
	{
		...
		return Redirect::direction('groupassignment.index');
	}
