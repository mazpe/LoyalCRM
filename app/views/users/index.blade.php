    ...
    @foreach($users as $key => $value)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success" href="{{ URL::to('users/' . $value->id) }}">Show this Users</a>

                <!-- edit this users (uses the edit method found at GET /users/{id}/edit -->
                <a class="btn btn-small btn-info" href="{{ URL::to('users/' . $value->id . '/edit') }}">Edit this Users</a>
